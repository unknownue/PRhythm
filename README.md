...
python scripts/analyze_pr.py --json path/to/pr_file.json
...
- **PR Information**: `output/repo_name/YYYY-MM/pr_123_20240228.json` (first file) or `output/repo_name/YYYY-MM/pr_123_20240228_1.json` (subsequent files)
- **Analysis Reports**: `analysis/repo_name/YYYY-MM/pr_123_zh-cn_20240228.md` (first file) or `analysis/repo_name/YYYY-MM/pr_123_zh-cn_20240228_1.md` (subsequent files)
- **Processing Status**: `repos/pr_processing_status.json`

The monthly directory structure (`YYYY-MM` format) helps organize files chronologically, making it easier to manage and locate reports over time. For files generated on the same day, a numerical suffix starting from 1 is added automatically.
